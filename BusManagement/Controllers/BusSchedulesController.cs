...
namespace BusManagement.Controllers
{
    ...
    public class BusSchedulesController : ControllerBase
    {
        ...
        public BusSchedulesController(BusContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<BusSchedule>>> GetSchedules()
        {
        ...
        {
            var busSchedule = await _context.Schedules.FindAsync(id);
        ...
        {
            _context.Schedules.Add(busSchedule);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteBusSchedule(int id)
        {
            ...
            _context.Schedules.Remove(busSchedule);
            await _context.SaveChangesAsync();
